            ...
            <div class="controls">
                <div class="">
                    <button class="custom-btn">
                        <font-awesome-icon :icon="icons.faSyncAlt" class="icon"></font-awesome-icon>Refresh
                    </button>
                </div>
            </div>
        ...
        <div class="content">
            <b-table selectable sticky-header select-mode="single" :items="items" :fields="fields" :filter="searchFilter" :filter-included-fields="filterOn" @row-contextmenu="onRowContextMenu" @row-selected="onRowSelected" @row-clicked="onRowClicked" @row-dblclicked="onRowDblClicked">
                ...
                <template #cell(status)="data">
                    <button class="update" v-if="!data.item.installed" @click="onClickInstall(data.item, $event)">Install</button>
                    <button class="update" v-if="data.item.installed" disabled>Installed</button>
                </template>
